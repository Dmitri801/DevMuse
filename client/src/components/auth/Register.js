// CLASS BASED COMPONENT w/STATE - short key = rcc *TABKEY*
...
class Register extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (this.state.email === '' || this.state.password === '' || this.state.password2 === '' || this.state.name === '') {
              ...
              <div className="col-md-8 m-auto">
                ...
                <form onSubmit={this.onSubmit} noValidate>
                  ...
                  <TextFieldGroup
                    ...
                    loading={this.state.loading}
                  />
                  {this.state.loading ? loadingWheel : <input
                    type="submit"
